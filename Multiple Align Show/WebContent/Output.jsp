...
<body>
	...
	<div class="container-fluid">
		<div id="demo" class="collapse">
			<div class="card2">
				<div class="card-body">
					...
					<div class="slidecontainer">
						<p>
							Select Font Size: <input type="range" min="8" max="51" value="16"
		...
		<button type="button" class="btnblue" onclick="capture()"><i class="fa fa-download"></i></button>
	</div>
	...
	<div id="div1" class="divPadding">
	
		<!-- <button id="btnReset">Clear Selection</button> -->


		<table class="tableFormate specific" id="our_table"
